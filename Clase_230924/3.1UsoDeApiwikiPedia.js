...
async function buscarEnWikipedia() {
    try {
        ...
        // Aquí deberías implementar la lógica para mostrar los resultados
        // Por ejemplo, puedes iterar sobre los resultados y crear elementos HTML
        // para mostrarlos en una lista en tu página
        catch (error) {
        console.error('Error al buscar en Wikipedia:', error);
    }
}

// Llamada a la función para iniciar la búsqueda
buscarEnWikipedia();
